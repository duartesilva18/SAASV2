...
function GoogleLoginButton({ onLoginSuccess }: { onLoginSuccess: (token: string) => void }) {
  ...
  return (
    <button
      type="button"
      onClick={() => login()}
      className="flex items-center justify-center gap-2 sm:gap-2.5 lg:gap-2.5 xl:gap-3 py-3 sm:py-3.5 lg:py-3 xl:py-4 [@media(max-height:700px)]:py-2.5 [@media(max-height:600px)]:py-2 px-5 sm:px-6 lg:px-6 xl:px-8 [@media(max-height:700px)]:px-5 [@media(max-height:600px)]:px-4 bg-slate-950 border border-slate-800 rounded-lg lg:rounded-lg xl:rounded-xl hover:bg-slate-900 hover:border-slate-700 transition-all group/btn shadow-lg cursor-pointer w-full max-w-[260px] sm:max-w-[280px] lg:max-w-[260px] xl:max-w-[300px] 2xl:max-w-[320px]"
    >
      <svg viewBox="0 0 24 24" className="w-4 h-4 sm:w-4 sm:h-4 lg:w-4 lg:h-4 xl:w-5 xl:h-5 fill-current shrink-0">
      ...
      <span className="text-xs sm:text-xs lg:text-sm xl:text-sm font-black uppercase tracking-widest text-slate-500 group-hover/btn:text-white transition-colors [@media(max-height:600px)]:text-[10px]">
      ...
      <div className="min-h-screen bg-[#020617] text-slate-50 flex flex-col lg:flex-row relative overflow-hidden">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto flex flex-col items-center justify-center lg:justify-start pt-5 sm:pt-6 lg:pt-7 xl:pt-9 2xl:pt-12 pb-6 sm:pb-8 lg:pb-10 xl:pb-12 2xl:pb-16 px-3 sm:px-4 lg:px-6 xl:px-10 2xl:px-16 [@media(max-height:1600px)]:pt-6 [@media(max-height:1400px)]:pt-6 [@media(max-height:1200px)]:pt-6 [@media(max-height:1080px)]:pt-6 [@media(max-height:1000px)]:pt-5 [@media(max-height:900px)]:pt-4 [@media(max-height:800px)]:pt-3.5 [@media(max-height:700px)]:pt-3 [@media(max-height:600px)]:pt-2.5 2xl:justify-center [@media(min-height:900px)]:justify-center relative z-10 bg-[#020617]/95 pb-[max(1rem,env(safe-area-inset-bottom))]">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full max-w-md xl:max-w-lg 2xl:max-w-xl mx-auto my-2 [@media(max-height:700px)]:min-w-0 [@media(max-height:1400px)]:my-1.5 [@media(max-height:1200px)]:my-1.5 [@media(max-height:1080px)]:my-1.5 [@media(max-height:1000px)]:my-1 [@media(max-height:900px)]:my-1 [@media(max-height:800px)]:my-1">
            <div className="mb-3 sm:mb-4 lg:mb-6 xl:mb-10 2xl:mb-14 [@media(max-height:1600px)]:mb-4 [@media(max-height:1400px)]:mb-4 [@media(max-height:1200px)]:mb-4 [@media(max-height:1080px)]:mb-4 [@media(max-height:1000px)]:mb-3 [@media(max-height:900px)]:mb-3 [@media(max-height:800px)]:mb-2 [@media(max-height:700px)]:mb-2 [@media(max-height:600px)]:mb-1.5 text-center lg:text-left">
              <div className="lg:hidden w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4 [@media(max-height:1600px)]:mb-2.5 [@media(max-height:1400px)]:mb-2.5 [@media(max-height:1200px)]:mb-2.5 [@media(max-height:1080px)]:mb-2.5 [@media(max-height:800px)]:mb-2 overflow-hidden bg-slate-800/90 shadow-xl">
                <img src="/images/logo/icon.jpeg" alt="Finly" className="w-full h-full object-cover" />
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-3xl xl:text-5xl 2xl:text-6xl font-black tracking-tighter mb-1.5 sm:mb-2 lg:mb-3 xl:mb-4 2xl:mb-5 [@media(max-height:1600px)]:mb-2 [@media(max-height:1400px)]:mb-2 [@media(max-height:1200px)]:mb-2 [@media(max-height:1080px)]:mb-2 [@media(max-height:1000px)]:mb-1.5 [@media(max-height:900px)]:mb-1.5 [@media(max-height:800px)]:mb-1 text-white">
                {t.auth.login.title}
            ...
            <motion.div
              ...
              className={`bg-slate-900/60 border p-9 sm:p-11 lg:p-14 xl:p-20 2xl:p-28 [@media(max-height:1600px)]:p-11 [@media(max-height:1400px)]:p-11 [@media(max-height:1200px)]:p-11 [@media(max-height:1080px)]:p-11 [@media(max-height:1000px)]:p-10 [@media(max-height:900px)]:p-9 [@media(max-height:800px)]:p-8 [@media(max-height:700px)]:p-8 [@media(max-height:600px)]:p-7 rounded-xl lg:rounded-2xl xl:rounded-[28px] 2xl:rounded-3xl relative overflow-hidden transition-colors duration-500 group/card ${error ? 'border-red-500/30 bg-red-500/5' : 'border-slate-800'}`}
            >
              <AnimatePresence mode="wait">
                {error && (
                  <motion.div
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-11 sm:space-y-12 lg:space-y-14 xl:space-y-16 2xl:space-y-20 [@media(max-height:1600px)]:space-y-11 [@media(max-height:1400px)]:space-y-11 [@media(max-height:1200px)]:space-y-11 [@media(max-height:1080px)]:space-y-11 [@media(max-height:1000px)]:space-y-10 [@media(max-height:900px)]:space-y-9 [@media(max-height:800px)]:space-y-8 [@media(max-height:700px)]:space-y-7 [@media(max-height:600px)]:space-y-6">
                <div>
                  <label className="block text-xs font-black uppercase tracking-[0.2em] lg:tracking-[0.3em] 2xl:tracking-[0.35em] text-slate-500 mb-2 lg:mb-3 2xl:mb-4 ml-3 lg:ml-4 2xl:ml-5">
                  ...
                  <div className="relative group/input">
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-950/50 border rounded-lg lg:rounded-xl xl:rounded-2xl 2xl:rounded-3xl py-2.5 sm:py-3 lg:py-4 xl:py-5 2xl:py-7 [@media(max-height:1600px)]:py-2.5 [@media(max-height:1400px)]:py-2.5 [@media(max-height:1200px)]:py-2.5 [@media(max-height:1080px)]:py-2.5 [@media(max-height:900px)]:py-2 [@media(max-height:800px)]:py-2 [@media(max-height:700px)]:py-2 [@media(max-height:600px)]:py-1.5 pl-10 lg:pl-14 2xl:pl-16 pr-3 lg:pr-5 2xl:pr-6 text-xs sm:text-sm lg:text-base 2xl:text-lg focus:outline-none transition-all placeholder:text-slate-800 font-medium ${error && !validateEmail(email) ? 'border-red-500/50 bg-red-500/5' : 'border-slate-800 focus:border-blue-500'}`}
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 lg:mb-3 2xl:mb-4 ml-3 lg:ml-4 2xl:ml-5">
                    <label className="block text-xs font-black uppercase tracking-[0.2em] lg:tracking-[0.3em] 2xl:tracking-[0.35em] text-slate-500">
                      {t.auth.login.passwordLabel}
                    </label>
                    <Link
                      href="/auth/forgot-password"
                      className="text-[10px] font-black uppercase tracking-widest text-blue-500 hover:text-blue-400 transition-colors underline decoration-blue-500/20 underline-offset-1 lg:underline-offset-4 2xl:text-xs cursor-pointer"
                    >
                  ...
                  <div className="relative group/input">
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-950/50 border rounded-lg lg:rounded-xl xl:rounded-2xl 2xl:rounded-3xl py-2.5 sm:py-3 lg:py-4 xl:py-5 2xl:py-7 [@media(max-height:1600px)]:py-2.5 [@media(max-height:1400px)]:py-2.5 [@media(max-height:1200px)]:py-2.5 [@media(max-height:1080px)]:py-2.5 [@media(max-height:1000px)]:py-2 [@media(max-height:900px)]:py-2 [@media(max-height:800px)]:py-2 [@media(max-height:700px)]:py-2 [@media(max-height:600px)]:py-1.5 pl-10 lg:pl-14 2xl:pl-16 pr-9 lg:pr-12 2xl:pr-14 text-xs sm:text-sm lg:text-base 2xl:text-lg focus:outline-none transition-all placeholder:text-slate-800 font-medium ${error && password.length < 4 ? 'border-red-500/50 bg-red-500/5' : 'border-slate-800 focus:border-blue-500'}`}
                      placeholder="••••••••••••"
                      required
                    />
                    <button
                ...
                <div className="flex items-center gap-2 lg:gap-3 2xl:gap-4 ml-2 lg:ml-3 2xl:ml-4 group cursor-pointer w-fit -mt-4 sm:-mt-5 lg:-mt-6 xl:-mt-8 2xl:-mt-10 [@media(max-height:1000px)]:-mt-4 [@media(max-height:800px)]:-mt-3 [@media(max-height:600px)]:-mt-2" onClick={() => setRememberMe(!rememberMe)}>
              ...
              <div className="mt-10 lg:mt-12 xl:mt-16 2xl:mt-28 [@media(max-height:1600px)]:mt-9 [@media(max-height:1400px)]:mt-9 [@media(max-height:1200px)]:mt-9 [@media(max-height:1080px)]:mt-8 [@media(max-height:1000px)]:mt-7 [@media(max-height:900px)]:mt-6 [@media(max-height:800px)]:mt-5 [@media(max-height:700px)]:mt-4 [@media(max-height:600px)]:mt-3">
                <div className="relative mb-6 lg:mb-8 2xl:mb-16 [@media(max-height:1400px)]:mb-5 [@media(max-height:1200px)]:mb-5 [@media(max-height:1080px)]:mb-5 [@media(max-height:1000px)]:mb-4 [@media(max-height:900px)]:mb-4 [@media(max-height:800px)]:mb-3 [@media(max-height:700px)]:mb-3 text-center">
                ...
                <div className="flex justify-center scale-[0.95] sm:scale-100 lg:scale-95 xl:scale-100 2xl:scale-105 -mt-1 lg:-mt-2">
                  <GoogleLoginButton onLoginSuccess={(token) => handleSocialLogin(token, 'google')} />
                </div>
              </div>
            </motion.div>

            <div className="mt-8 lg:mt-10 xl:mt-14 2xl:mt-24 [@media(max-height:1600px)]:mt-7 [@media(max-height:1400px)]:mt-7 [@media(max-height:1200px)]:mt-7 [@media(max-height:1080px)]:mt-7 [@media(max-height:1000px)]:mt-6 [@media(max-height:900px)]:mt-5 [@media(max-height:800px)]:mt-4 [@media(max-height:700px)]:mt-3 [@media(max-height:600px)]:mt-2.5 text-center flex flex-col items-center">
              <p className="text-slate-500 font-medium text-sm sm:text-base lg:text-base xl:text-lg 2xl:text-xl mb-4 lg:mb-5 xl:mb-8 2xl:mb-12 [@media(max-height:1600px)]:mb-3 [@media(max-height:1400px)]:mb-3 [@media(max-height:1200px)]:mb-3 [@media(max-height:1080px)]:mb-3 [@media(max-height:1000px)]:mb-2.5 [@media(max-height:900px)]:mb-2 [@media(max-height:800px)]:mb-2 [@media(max-height:700px)]:mb-1.5 [@media(max-height:600px)]:mb-1 italic">
                {t.auth.login.noAccount}
              </p>
              <Link
                href="/auth/register"
                className="inline-flex items-center justify-center gap-2 sm:gap-2.5 lg:gap-2.5 xl:gap-3 bg-slate-900/60 border border-slate-800 hover:border-blue-500/50 px-5 sm:px-6 lg:px-6 xl:px-8 py-3 sm:py-3.5 lg:py-3 xl:py-4 [@media(max-height:700px)]:px-5 [@media(max-height:700px)]:py-2.5 [@media(max-height:600px)]:px-4 [@media(max-height:600px)]:py-2 rounded-xl lg:rounded-xl xl:rounded-2xl font-black uppercase tracking-[0.15em] lg:tracking-[0.2em] text-xs sm:text-xs lg:text-sm xl:text-sm [@media(max-height:600px)]:text-[10px] text-white transition-all hover:scale-105 active:scale-95 group shadow-xl cursor-pointer"
              >
                {t.auth.login.registerCta}
                <Sparkles size={14} className="text-blue-500 group-hover:rotate-12 transition-transform w-4 h-4 sm:w-4 sm:h-4 lg:w-4 lg:h-4 xl:w-5 xl:h-5 [@media(max-height:600px)]:w-3.5 [@media(max-height:600px)]:h-3.5" />
              </Link>
            </div>
          </motion.div>
        </div>
