...
function RegisterPageContent() {
  ...
  return (
    ...
    <div className="min-h-screen min-h-[100dvh] bg-[#020617] text-slate-50 flex flex-col md:flex-row relative overflow-x-hidden overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-3 sm:p-5 lg:p-12 xl:p-24 relative z-10 bg-[#020617] pb-[max(0.5rem,env(safe-area-inset-bottom))] min-h-0 overflow-y-auto">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full max-w-[520px] py-1">
          <div className="mb-4 sm:mb-6 lg:mb-12 text-center lg:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-black tracking-tighter mb-2 sm:mb-3 lg:mb-4 text-white">
              ...
              <span className="text-emerald-500 italic font-black ml-1 sm:ml-2">{t.auth.register.titleAccent}</span>
            </h1>
          ...
          <motion.div
            ...
            className={`bg-slate-900/60 border p-4 sm:p-6 lg:p-12 rounded-2xl sm:rounded-[32px] relative overflow-hidden transition-all duration-500 ${error ? 'border-red-500/30 bg-red-500/5' : 'border-slate-800'}`}
          >
            <AnimatePresence mode="wait">
              {success && (
                <motion.div
            ...
            <form onSubmit={handleSubmit} noValidate className={`space-y-4 sm:space-y-6 lg:space-y-8 ${success ? 'pointer-events-none opacity-50' : ''}`}>
              <div>
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-950/50 border rounded-xl sm:rounded-[24px] py-3.5 sm:py-4 lg:py-6 pl-12 sm:pl-14 pr-5 text-sm lg:text-base focus:outline-none transition-all placeholder:text-slate-800 font-medium ${error && !validateEmail(email) ? 'border-red-500/50 bg-red-500/5' : 'border-slate-800 focus:border-emerald-500'}`}
              ...
              <div>
                ...
                <div className="relative group/input mb-3 sm:mb-4">
                  ...
                  <input
                    ...
                    className={`w-full bg-slate-950/50 border rounded-xl sm:rounded-[24px] py-3.5 sm:py-4 lg:py-6 pl-12 sm:pl-14 lg:pl-16 pr-12 sm:pr-14 text-sm lg:text-base focus:outline-none transition-all placeholder:text-slate-800 font-medium ${error && password.length < 6 ? 'border-red-500/50 bg-red-500/5' : 'border-slate-800 focus:border-emerald-500'}`}
                    placeholder="••••••••••••"
                    required
                  />
                  <button
              ...
              <MagneticButton
                type="submit"
                disabled={loading}
                className="w-full py-3.5 sm:py-4 lg:py-7 min-h-[44px] sm:min-h-[48px] bg-emerald-600 hover:bg-emerald-500 disabled:bg-emerald-800 disabled:cursor-not-allowed text-white rounded-xl sm:rounded-[24px] font-black uppercase tracking-[0.3em] transition-all shadow-[0_20px_40px_-10px_rgba(16,185,129,0.5)] active:scale-[0.98] mt-2 sm:mt-4 flex items-center justify-center gap-2 sm:gap-3 lg:gap-4 text-xs lg:text-sm relative overflow-hidden cursor-pointer"
              >
                {loading ? (
          ...
          <div className="mt-5 sm:mt-8 lg:mt-14 text-center">
            ...
            <Link
              href="/auth/login"
              className="inline-flex items-center gap-2 sm:gap-3 lg:gap-4 bg-slate-900/60 border border-slate-800 hover:border-emerald-500/50 px-5 sm:px-8 lg:px-12 py-3 sm:py-4 lg:py-6 rounded-xl sm:rounded-[24px] font-black uppercase tracking-[0.2em] text-[10px] lg:text-sm text-white transition-all hover:scale-105 active:scale-95 group shadow-xl cursor-pointer"
            >
      ...
      <div className="absolute bottom-3 sm:bottom-5 lg:bottom-12 left-1/2 -translate-x-1/2 lg:left-auto lg:right-12 lg:translate-x-0 text-[8px] lg:text-[10px] font-black text-slate-700 uppercase tracking-[0.4em] lg:tracking-[0.5em] opacity-50 flex items-center gap-2 lg:gap-3 whitespace-nowrap">
