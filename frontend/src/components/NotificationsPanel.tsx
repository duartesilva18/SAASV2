  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`w-full max-w-[320px] bg-[#0a0f1d] border border-white/10 rounded-2xl shadow-[0_10px_100px_-10px_rgba(0,0,0,0.9)] z-[200] p-5 notification-card ${className}`}
