...
TELEGRAM_TRANSLATIONS = {
    'pt': {
        ...
        'button_edit_amount': '✏️ Valor',
        'edit_amount_prompt': '✏️ Envia o novo valor (ex.: <code>12,50</code>).',
        'edit_amount_invalid': '⚠️ Não percebi o valor. Envia só o número (ex.: <code>12,50</code>).',
        'auto_registered_hint': '↩️ Enganei-me? <code>/desfazer</code>',
        'change_category_prompt': '🏷️ <b>Escolhe a categoria:</b>',
        'source_cache': 'Por cache',
        'source_history': 'Por histórico',
        'source_openai': 'Por IA',
        'source_fallback': 'A rever — não tenho a certeza',
        ...
        'amount_too_large': "⚠️ Esse valor é demasiado alto (máximo 999.999,99€). Verifica o valor e tenta de novo.",
        ...
        'invite_header': "🤝 <b>Convida amigos, ganha comissão</b>\n\nReencaminha a mensagem seguinte a quem quiseres — cada subscrição pelo teu link rende-te comissão todos os meses:",
        'invite_message': "Uso a Finly para controlar os meus gastos diretamente no Telegram — escrevo \"café 1,20€\" e está registado. Experimenta: {link}",
        'invite_not_affiliate': "🤝 Ainda não és afiliado. Ativa em {url} — depois o <code>/convidar</code> dá-te o teu link pessoal (20-25% de comissão recorrente).",
        'duplicate_registered_warning': "👀 Já tinhas registado <b>{description}</b> — <code>{amount}€</code> há menos de 10 minutos. Se foi engano, envia <code>/desfazer</code>.",
        'wrapped_caption': "📸 O teu mês em números. Partilha nos stories e mostra que tens as contas na mão! 💪",
        'shared_you': "Tu",
        'shared_breakdown': "👥 {parts}",
    ...
    'en': {
        ...
        'button_edit_amount': '✏️ Amount',
        'edit_amount_prompt': '✏️ Send the new amount (e.g. <code>12.50</code>).',
        'edit_amount_invalid': '⚠️ Could not read that amount. Send just the number (e.g. <code>12.50</code>).',
        'auto_registered_hint': '↩️ Made a mistake? <code>/undo</code>',
        'change_category_prompt': '🏷️ <b>Choose category:</b>',
        'source_cache': 'From cache',
        'source_history': 'From history',
        'source_openai': 'From AI',
        'source_fallback': 'To review — not sure',
        ...
        'amount_too_large': "⚠️ That amount is too high (maximum €999,999.99). Check the value and try again.",
        ...
        'invite_header': "🤝 <b>Invite friends, earn commission</b>\n\nForward the next message to anyone — every subscription through your link earns you commission every month:",
        'invite_message': "I use Finly to track my spending right inside Telegram — I type \"coffee 1.20€\" and it's logged. Try it: {link}",
        'invite_not_affiliate': "🤝 You're not an affiliate yet. Activate it at {url} — then <code>/convidar</code> gives you your personal link (20-25% recurring commission).",
        'duplicate_registered_warning': "👀 You already logged <b>{description}</b> — <code>{amount}€</code> less than 10 minutes ago. If that was a mistake, send <code>/desfazer</code>.",
        'wrapped_caption': "📸 Your month in numbers. Share it to your stories and show you've got your money under control! 💪",
        'shared_you': "You",
        'shared_breakdown': "👥 {parts}",
