...
TELEGRAM_TRANSLATIONS = {
    'pt': {
        ...
        'help_guide': (
            "<b>Guia Rápido · Finan</b><i>Zen</i>\n\n"
            "📌 <b>1. Como falar comigo</b>\n"
            "Escreve de forma natural. Exemplos simples:\n"
            "• 🍽️ <code>Almoço 15€</code>\n"
            "• 💰 <code>Salário 1000€</code>\n"
            "• ⛽ <code>Gasolina 40€</code>\n"
            "• 🧾 <code>Almoço 25€ gasolina 10€</code>\n\n"
            "⚙️ <b>2. Comandos principais</b>\n"
            ...
            "💬 <b>3. Exemplos de mensagens</b>\n"
            "• \"Quanto gastei este mês em restaurantes?\"\n"
            "• \"Estou a gastar mais ou menos do que no mês passado?\"\n"
            "• \"Analisa as minhas finanças deste mês e diz-me se estou equilibrado.\"\n\n"
            "🆘 <b>4. Ajuda & problemas</b>\n"
            "• Se eu disser que não encontro o workspace: confirma se estás em Pro na app.\n"
            "• Se não reconhecer o email: garante que é o mesmo da plataforma.\n"
            "• Podes sempre voltar a começar com <code>/start</code>.\n\n"
            "🧘‍♂️ <i>Usa-me todos os dias para manter o teu ecossistema financeiro zen.</i>"
        ),
        'rate_limit': (
